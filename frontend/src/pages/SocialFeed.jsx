    ...
    <div className="page-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '1.5rem' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr 300px', gap: '1.5rem', alignItems: 'start' }}>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 0.25rem 0', fontSize: '1.1rem', fontWeight: '600', color: 'rgba(255,255,255,0.95)' }}>{currentUser?.fullName}</h3>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '0.85rem', textAlign: 'left', fontSize: '0.8rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>
              ...
              <span style={{ color: 'rgba(255,255,255,0.8)', fontWeight: '500' }}>{currentUser?.department}</span>
            </div>
                ...
                <div key={post.id} style={{
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem' }}>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                          <span style={{ fontWeight: '600', fontSize: '0.9rem', color: 'rgba(255,255,255,0.95)' }}>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.4rem' }}>
                      <h3 style={{ margin: 0, fontSize: '1.05rem', fontWeight: '600', color: '#fff', lineHeight: '1.4' }}>
                        {post.title}
                      </h3>
                      {post.startupName && (
                          ...
                          comments.map(c => (
                            <div key={c.id} style={{
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                                  <span style={{ fontWeight: '600', fontSize: '0.78rem', color: 'rgba(255,255,255,0.9)' }}>
                                    {c.userName}
                                  </span>
                                  <span style={{
                                    fontSize: '0.58rem',
                              ...
                              <p style={{ margin: '0.35rem 0 0 0', fontSize: '0.8rem', color: 'rgba(255,255,255,0.85)', lineHeight: '1.4' }}>
                                {c.content}
                              </p>
                            </div>
                          ))
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 1rem 0', fontSize: '0.95rem', fontWeight: '600', color: '#fff', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem' }}>
              🚀 Funding Activities
            </h3>
                ...
                {activities.map(act => (
                  <div key={act.id} style={{ fontSize: '0.78rem', lineHeight: '1.4' }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.4rem' }}>
                      <span style={{ fontSize: '1rem' }}>💸</span>
                      <div>
                        <span style={{ fontWeight: '600', color: 'rgba(255,255,255,0.9)' }}>{act.investorName}</span>
                        ...
                        <span style={{ fontWeight: '500', color: '#fff' }}>"{act.proposalTitle}"</span>
