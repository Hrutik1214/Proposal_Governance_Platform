    ...
    <div className="page-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '1.5rem' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr 300px', gap: '1.5rem', alignItems: 'start' }}>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 0.25rem 0', fontSize: '1.1rem', fontWeight: '700', color: '#000000' }}>{currentUser?.fullName}</h3>
          <p style={{ margin: '0 0 0.75rem 0', fontSize: '0.8rem', color: '#1E293B', fontWeight: '500' }}>{currentUser?.email}</p>
          
          <div style={{ display: 'inline-block', padding: '0.25rem 0.75rem', borderRadius: '20px', background: 'var(--bg-tertiary)', border: '1px solid var(--border-color)', marginBottom: '1rem' }}>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '0.85rem', textAlign: 'left', fontSize: '0.8rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', color: '#1E293B', marginBottom: '0.4rem' }}>
              <span>Department</span>
              <span style={{ color: '#000000', fontWeight: '700' }}>{currentUser?.department}</span>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{
            ...
            <h2 style={{ margin: 0, fontSize: '1.3rem', fontWeight: '700', color: '#000000', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              🌐 Community Feed
            </h2>
                ...
                <div key={post.id} style={{
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.4rem' }}>
                      <h3 style={{ margin: 0, fontSize: '1.05rem', fontWeight: '700', color: '#000000', lineHeight: '1.4' }}>
                        {post.title}
                      </h3>
                      {post.startupName && (
                        <div style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.2)', borderRadius: '12px', padding: '0.1rem 0.5rem' }}>
                          <span style={{ fontSize: '0.65rem', color: '#1D4ED8', fontWeight: '700' }}>🚀 {post.startupName}</span>
                        </div>
                      )}
                    ...
                    <p style={{ margin: 0, fontSize: '0.88rem', color: '#000000', fontWeight: '500', lineHeight: '1.5', whiteSpace: 'pre-wrap' }}>
                      {displayDesc}
                          ...
                          comments.map(c => (
                            <div key={c.id} style={{
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                                  <span style={{ fontWeight: '700', fontSize: '0.78rem', color: '#000000' }}>
                                    {c.userName}
                                  </span>
                                  <span style={{
                                    fontSize: '0.58rem',
                              ...
                              <p style={{ margin: '0.35rem 0 0 0', fontSize: '0.82rem', color: '#000000', fontWeight: '500', lineHeight: '1.4' }}>
                                {c.content}
                              </p>
                            </div>
                          ))
