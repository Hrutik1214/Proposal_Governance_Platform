    ...
    <div className="page-container" style={{ height: 'calc(100vh - 100px)', padding: '1rem', display: 'flex', gap: '1rem', maxWidth: '1400px' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '1.25rem', borderBottom: '1px solid var(--border-color)', background: 'rgba(0,0,0,0.1)' }}>
          <h3 style={{ fontSize: '1rem', fontWeight: '600', color: '#fff', fontFamily: 'var(--font-mono)' }}>
            💬 PRIVATE CHATS
          </h3>
        </div>
        ...
        {activeRoom ? (
          <>
            ...
            <div style={{
              ...
              <div>
                <h3 style={{ margin: 0, fontSize: '1rem', color: '#fff' }}>{activeRoom.proposalTitle}</h3>
                        ...
                        {msg.messageType === 'meeting_request' ? (
                          ...
                          <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.5rem' }}>
                              ...
                              <strong style={{ fontSize: '0.8rem', color: '#fff' }}>Meeting Request</strong>
                          ...
                          <>
                            <p style={{ margin: 0, fontSize: '0.85rem', color: '#fff', lineHeight: '1.4', whiteSpace: 'pre-wrap' }}>
                              {msg.content}
                            </p>
