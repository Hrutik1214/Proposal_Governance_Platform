    ...
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          ...
          <p>Grant, revoke, modify terms, and manage user subscription accounts.</p>
        </div>
      </div>
                        ...
                        return (
                          ...
                          >
                            <td style={{ paddingLeft: '1rem' }}>
                              ...
                              <div style={{ fontSize: '0.72rem', color: 'var(--accent-cyan)', display: 'flex', alignItems: 'center', gap: '0.2rem', marginTop: '0.15rem' }}>
                                📞 {u.contactNumber || u.ContactNumber || u.contact || 'No contact specified'}
                              </div>
                            </td>
                            <td>
              ...
              <div className="detail-card">
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                    Email: {selectedUser.email} | Contact: <b style={{ color: 'var(--accent-cyan)' }}>{selectedUser.contactNumber || selectedUser.ContactNumber || 'Not provided'}</b> | Role: <b>{selectedUser.role}</b>
                  </span>
                </div>
