                ...
                return (
                  <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.02)', padding: '0.85rem', borderRadius: '6px', border: '1px solid var(--border-color)' }}>
                      ...
                      <p style={{ margin: '0.25rem 0 0 0', fontWeight: '600', fontSize: '0.95rem', color: 'white' }}>{details.Title}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p style={{ margin: '0.25rem 0 0 0', fontWeight: '500', color: 'white', fontSize: '0.85rem' }}>{details.Inventors}</p>
                    </div>
