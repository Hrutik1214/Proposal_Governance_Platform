...
const TAB_TITLES = {
  ...
  dashboard:            { label: 'My Proposals' },
  'new-proposal':       { label: 'Submit New Proposal' },
  feed:                 { label: 'Community Feed' },
  marketplace:          { label: 'Proposal Marketplace' },
  discussions:          { label: 'Discussion Rooms' },
  reviews:              { label: 'Evaluation Queue' },
  admin:                { label: 'Governance & Approvals' },
  analytics:            { label: 'System Analytics' },
  'verification-review':{ label: 'Verify Founders' },
  subscription:         { label: 'Subscription Plans' },
  trust:                { label: 'Trust Scores' },
  verification:         { label: 'Verification Centre' },
};
...
export default function Navbar({ user, currentTab, handleLogout, theme, toggleTheme, onMenuClick }) {
  ...
  const pageInfo = TAB_TITLES[currentTab] || { label: 'Governance Portal' };
