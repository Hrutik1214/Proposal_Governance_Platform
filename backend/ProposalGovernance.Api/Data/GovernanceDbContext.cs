    ...
    public class GovernanceDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Subscription>().HasData(
                ...
                new Subscription { Id = 2, Name = "Founder Premium", UserRole = UserRoles.Founder, Price = 20.00m, DurationInDays = 30, Description = "Priority listing, visibility boost, verified badge, and priority consultation." },
                ...
                new Subscription { Id = 4, Name = "Investor Premium", UserRole = UserRoles.Investor, Price = 20.00m, DurationInDays = 30, Description = "Advanced filters, comparisons, risk reports, and trust breakdown." }
            );
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Username = "admin", PasswordHash = adminHash, Role = UserRoles.Admin, FullName = "System Administrator", Email = "admin@governance.com", ContactNumber = "+91 9876543210", Department = "Finance" },
                new User { Id = 2, Username = "reviewer1", PasswordHash = revHash1, Role = UserRoles.Reviewer, FullName = "Sarah Jenkins", Email = "sjenkins@governance.com", ContactNumber = "+91 9876543211", Department = "Engineering" },
                new User { Id = 3, Username = "reviewer2", PasswordHash = revHash2, Role = UserRoles.Reviewer, FullName = "David Vance", Email = "dvance@governance.com", ContactNumber = "+91 9876543212", Department = "Operations" },
                new User 
                { 
                    Id = 4, 
                    Username = "submitter1", 
                ...
                new User { Id = 5, Username = "submitter2", PasswordHash = subHash2, Role = UserRoles.Founder, FullName = "Bob Martin", Email = "bmartin@governance.com", ContactNumber = "+91 9898765432", Department = "Marketing" },
                new User { Id = 6, Username = "investor1", PasswordHash = BCrypt.Net.BCrypt.HashPassword("investor123"), Role = UserRoles.Investor, FullName = "Priya Kapoor", Email = "pkapoor@venturefund.com", ContactNumber = "+91 9711223344", Department = "Finance" }
            );
